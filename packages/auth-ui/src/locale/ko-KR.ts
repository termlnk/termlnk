...
export default {
  'auth-ui': {
    ...
    'change-password': {
      title: '비밀번호 변경',
      subtitle: '계정 비밀번호를 변경합니다. 다른 모든 기기에서 로그아웃됩니다.',
      current: '현재 비밀번호',
      'current-placeholder': '현재 비밀번호 입력',
      new: '새 비밀번호',
      'new-placeholder': '{0}자 이상',
      confirm: '새 비밀번호 확인',
      'confirm-placeholder': '새 비밀번호를 다시 입력',
      'too-short': '{0}자 이상으로 설정해 주세요.',
      mismatch: '비밀번호가 일치하지 않습니다.',
      warning: '비밀번호를 변경하면 다른 모든 기기에서 로그아웃됩니다. 새 비밀번호로 다시 로그인해야 합니다.',
      submit: '비밀번호 변경',
      submitting: '변경 중…',
