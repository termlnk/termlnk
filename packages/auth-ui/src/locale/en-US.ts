...
export default {
  'auth-ui': {
    ...
    'change-password': {
      ...
      subtitle: 'Update your account password. All other devices will be signed out.',
      current: 'Current password',
      'current-placeholder': 'Enter your current password',
      new: 'New password',
      'new-placeholder': 'At least {0} characters',
      confirm: 'Confirm new password',
      'confirm-placeholder': 'Re-enter the new password',
      'too-short': 'Use at least {0} characters.',
      mismatch: 'Passwords do not match.',
      warning: 'Changing your password will sign out all other devices. They will need to sign in again with the new password.',
