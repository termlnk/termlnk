...
export default {
  'auth-ui': {
    ...
    'change-password': {
      title: 'パスワード変更',
      subtitle: 'アカウントのパスワードを変更します。他のすべてのデバイスからログアウトされます。',
      current: '現在のパスワード',
      'current-placeholder': '現在のパスワードを入力',
      new: '新しいパスワード',
      'new-placeholder': '{0}文字以上',
      confirm: '新しいパスワードの確認',
      'confirm-placeholder': '新しいパスワードを再入力',
      'too-short': '{0}文字以上にしてください。',
      mismatch: 'パスワードが一致しません。',
      warning: 'パスワードを変更すると、他のすべてのデバイスからログアウトされます。新しいパスワードで再ログインが必要です。',
      submit: 'パスワードを変更',
      submitting: '変更中…',
