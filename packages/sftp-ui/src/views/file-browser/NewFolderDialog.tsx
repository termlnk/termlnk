...
export function NewFolderDialog({ onSubmit, onCancel }: INewFolderDialogProps) {
      ...
      <DialogPortal>
        ...
        >
          <DialogHeader className="tm:gap-1">
            <DialogTitle className="tm:text-[15px] tm:font-semibold tm:text-white">New Folder</DialogTitle>
          ...
          >
            ...
            <Button variant="primary" size="sm" onClick={handleSubmit} disabled={!value.trim()}>Create</Button>
          </DialogFooter>
        </DialogContent>
      </DialogPortal>
    </DialogPrimitive>
