      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          `
            ...
            tm:border-line tm:bg-black tm:p-4 tm:text-white tm:shadow-lg tm:outline-hidden tm:duration-200
            tm:fill-mode-both
      ...
      >
        ...
        {closable && (
          <DialogPrimitive.Close
            ...
            className={`
              tm:absolute tm:top-4 tm:right-4 tm:rounded-xs tm:opacity-70 tm:backdrop-blur-sm
              tm:hover:text-blue
