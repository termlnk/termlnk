      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          `
            ...
            tm:w-full tm:max-w-[calc(100%-2rem)] tm:translate-x-[-50%] tm:translate-y-[-50%] tm:gap-4 tm:overflow-y-auto
            tm:rounded-lg tm:border tm:bg-one-bg tm:p-4 tm:text-white tm:shadow-lg tm:outline-hidden tm:duration-200
            tm:fill-mode-both
