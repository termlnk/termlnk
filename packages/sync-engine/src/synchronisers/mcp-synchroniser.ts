...
import type { IPushAcceptedDetail, IResourceSynchroniser, ISyncEntityRow, ISyncMutation, ISyncPatchApplyResult, ISyncPatchItem, ISyncWritableRow } from '@termlnk/sync';
