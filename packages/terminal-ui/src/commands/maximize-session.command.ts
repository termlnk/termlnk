...
export const MaximizeSessionCommand: ICommand = {
  id: 'terminal-ui.command.maximize-session',
  handler: (accessor: IAccessor) => {
    ...
    workspaceService.toggleMagnify(workspace.id, workspace.activeSessionId);
    return true;
  },
};
