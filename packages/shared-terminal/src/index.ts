...
export { SHARED_TERMINAL_CAPABILITY_VERSION, SHARED_TERMINAL_DRIVER_HEARTBEAT_TIMEOUT_MS, SHARED_TERMINAL_FRAME_MAX_PAYLOAD, SHARED_TERMINAL_FRAME_PREFIX, SHARED_TERMINAL_FRAME_VERSION, SHARED_TERMINAL_HEARTBEAT_MS, SHARED_TERMINAL_INVITE_DEFAULT_TTL_MS, SHARED_TERMINAL_RECONNECT_INITIAL_MS, SHARED_TERMINAL_RECONNECT_MAX_MS, SHARED_TERMINAL_RING_BUFFER_BYTES } from './common/constants';
