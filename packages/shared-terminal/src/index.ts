...
export {
  ...
  SHARED_TERMINAL_FRAME_MAX_PAYLOAD,
...
export type {
  ISharedTerminalError,
  SharedTerminalErrorCode,
} from './services/shared-terminal.service';
export { ISharedTerminalService } from './services/shared-terminal.service';
export type {
  IInboundFrame,
  ITransportConnectOptions,
  ITransportSendOptions,
