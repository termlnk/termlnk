...
export class CopilotHookAdapter extends BaseConfigFileAdapter {
  readonly agentType: ExternalAgentType = 'copilot';
  ...
  readonly definition: IAgentHookDefinition = {
    ...
    disableEnvVar: 'TERMLNK_COPILOT_HOOKS_DISABLED',
    ...
    events: [
      ...
      // Copilot fires Notification as its turn-completion signal
