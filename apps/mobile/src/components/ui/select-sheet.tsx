                  ...
                  <View key={opt.value}>
                    ...
                    >
                      <View className="flex-1">
                        <Text className="text-[15px] font-medium leading-[20px] text-content">{opt.label}</Text>
                        {opt.subtitle != null && (
                          <Text className="mt-1.5 text-[12px] leading-4 text-content-secondary">{opt.subtitle}</Text>
                        )}
                      </View>
                      {isSelected && (
