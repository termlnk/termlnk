...
import { useObservable, useSnippetRepository, useSyncService } from '../../src/core/core-context';
...
import { filterSnippets, groupSnippets } from '../../src/ui/snippet-utils';
          ...
          >
            ...
            {packages.map((pkg) => {
              ...
              return (
                <View key={pkg.id} className="mt-5">
                  ...
                  >
                    <Text className="mb-2 px-1 text-[12px] font-semibold uppercase tracking-wider text-content-tertiary">
                      {pkg.label}
                    </Text>
                  </Pressable>
            ...
            {filtered.length === 0 && search && (
              <View className="items-center py-8">
                <Text className="text-[14px] text-content-tertiary">No snippets match "{search}"</Text>
              </View>
            )}
          </ScrollView>
        )}
