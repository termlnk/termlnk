...
export default defineConfig({
  ...
  schema: [
    ...
    './src/entities/ai-provider.ts',
    './src/entities/ai-provider-model.ts',
    './src/entities/ai-custom-model.ts',
    './src/entities/ai-chat-session.ts',
    './src/entities/ai-chat-message.ts',
  ],
  out: './src/migrations',
